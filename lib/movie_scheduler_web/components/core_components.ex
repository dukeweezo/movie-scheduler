defmodule MovieSchedulerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MovieSchedulerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MovieSchedulerWeb.Gettext, "errors", msg, opts)
    end
  end
